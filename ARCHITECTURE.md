...
| **Videos**   | ![YouTube](https://img.shields.io/badge/-YouTube-FF0000?logo=youtube&logoColor=white)      | API Sync, Independent Collection.        |
...
- **`VideoGalleryComponent`**:
  - _Responsabilidade_: Exibir biblioteca de vídeos independente.
  - _Acesso_: Público.
...
- **`services/`**: Lógica de negócios.
  - `youtube_sync.py`: Sincronização automática com canais do YouTube.
  - `videos.py`: CRUD e queries para a collection independente.
